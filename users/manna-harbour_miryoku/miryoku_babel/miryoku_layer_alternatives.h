...
U_NP,              U_NP,              LT(U_MEDIA,KC_DEL),  LT(U_SYM,KC_SPC),  LT(U_FUN,KC_TAB),LT(U_NAV,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_MOUSE,KC_ESC),U_NP,              U_NP
...
LGUI_T(KC_Q),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_M),      \
LT(U_BUTTON,KC_W), ALGR_T(KC_X),      KC_C,              KC_V,              KC_B,              KC_N,              KC_COMM,           KC_DOT,            ALGR_T(KC_SLSH),   LT(U_BUTTON,KC_QUOT),\
U_NP,              U_NP,              LT(U_MOUSE,KC_ESC),LT(U_NUM,KC_BSPC), LT(U_NAV,KC_ENT),  LT(U_FUN,KC_TAB),LT(U_SYM,KC_SPC),  LT(U_MEDIA,KC_DEL),  U_NP,              U_NP
...
U_NP,              U_NP,              KC_DEL,            KC_SPC,            KC_TAB,            KC_ENT,            KC_BSPC            KC_ESC,            U_NP,              U_NP
...
KC_Q,              KC_S,              KC_D,              KC_F,              KC_G,              KC_H,              KC_J,              KC_K,              KC_L,              KC_M,              \
KC_W,              KC_X,              KC_C,              KC_V,              KC_B,              KC_N,              KC_COMM,           KC_DOT,            KC_SLSH,           KC_QUOT,           \
U_NP,              U_NP,              KC_ESC,            KC_BSPC,           KC_ENT,            KC_TAB,            KC_SPC,            KC_DEL,            U_NP,              U_NP
...
U_NP,              U_NP,              KC_DEL,            KC_SPC,            KC_TAB,            U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_TAB,            KC_SPC,            KC_DEL,            U_NP,              U_NP
...
RGB_SPI,           RGB_HUI,           RGB_SAI,           RGB_VAI,           RGB_TOG,           U_NA,              TD(U_TD_U_BASE),   TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
RGB_SPD,           RGB_HUD,           RGB_SAD,           RGB_VAD,           RGB_MOD,           U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
KC_MPRV,           KC_VOLD,           KC_VOLU,           KC_MNXT,           OU_AUTO,           U_NA,              TD(U_TD_U_MEDIA),  TD(U_TD_U_FUN),    KC_ALGR,           U_NA,              \
U_NP,              U_NP,              KC_MUTE,           KC_MPLY,           KC_MSTP,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              KC_ASTR,           KC_7,              KC_8,              KC_9,              U_NP,              \
...
KC_ASTR,           KC_7,              KC_8,              KC_9,              U_NP,              U_NA,              TD(U_TD_U_BASE),   TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
...
KC_EXLM,           KC_AT,             KC_LCBR,           KC_RCBR,           KC_TILD,           U_NA,              TD(U_TD_U_BASE),   TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
