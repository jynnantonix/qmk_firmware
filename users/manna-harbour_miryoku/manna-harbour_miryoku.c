...
void u_td_fn_ergodox_base(tap_dance_state_t *state, void *user_data) {
  if (state->count == 2) {
...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [U_TD_ERGODOX_BASE] = ACTION_TAP_DANCE_FN(u_td_fn_ergodox_base),
...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_TAB,          KC_Q,        KC_W,          KC_E,    KC_R,    KC_T,    KC_BSPC,             TG(SYMB),     KC_Y,    KC_U,    KC_I,    KC_O,              KC_P,           KC_BSLS,
  KC_LCTL,         KC_A,        KC_S,          KC_D,    KC_F,    KC_G,                                        KC_H,    KC_J,    KC_K,    KC_L,    LT(MDIA, KC_SCLN), GUI_T(KC_QUOT),
  KC_LSFT,         KC_Z,        KC_X,          KC_C,    KC_V,    KC_B,    KC_ENT,                  MEH_T(KC_NO), KC_N,    KC_M,    KC_COMM, KC_DOT,           CTL_T(KC_SLSH), KC_RSFT,
  LT(SYMB,KC_GRV), KC_QUOT,     KC_LSFT,    KC_LALT, KC_LCTL,                                              KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, TT(SYMB),
                                                           ALT_T(KC_APP), KC_LGUI,                KC_LALT, CTL_T(KC_ESC),
                                                                          KC_HOME,                 KC_PGUP,
                                                         KC_SPC, KC_LCTL, KC_END,                  KC_PGDN, KC_TAB, KC_ENT
),
